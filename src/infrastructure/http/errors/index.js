...
// 500 - Unknown Error
module.exports.ServerError = createHttpError('ServerError', function(message, code) {
	this.message = message || 'Server Error';
	this.code = code || HTTP_CODES.ServerError;
});

// 40X - Client Error
module.exports.ClientError = createHttpError('ClientError', function(message, code) {
	this.message = message || 'Client Error';
	this.code = code || HTTP_CODES.ClientError;
});
